...
/**
 * This is the item provider adapter for a {@link org.omg.CVLMetamodelMaster.cvl.VInterface} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VInterfaceItemProvider extends VPackageableItemProvider {
	/**
	 ...
	 * @generated
	 */
	public VInterfaceItemProvider(AdapterFactory adapterFactory) {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VInterface_super_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VInterface_super_feature", "_UI_VInterface_type"),
				 CvlPackage.Literals.VINTERFACE__SUPER,
				 true,
				 false,
				 true,
				 null,
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VInterface"));
	}
	...
	public String getText(Object object) {
		String label = ((VInterface)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_VInterface_type") :
			getString("_UI_VInterface_type") + " " + label;
	}
