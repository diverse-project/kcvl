...
/**
 * This is the item provider adapter for a {@link org.omg.CVLMetamodelMaster.cvl.VConfiguration} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class VConfigurationItemProvider extends VSpecResolutionItemProvider {
	/**
	 ...
	 * @generated
	 */
	public VConfigurationItemProvider(AdapterFactory adapterFactory) {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addResolvedVIRefPropertyDescriptor(object);
		}
	...
	protected void addSuperPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VConfiguration_super_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VConfiguration_super_feature", "_UI_VConfiguration_type"),
				 CvlPackage.Literals.VCONFIGURATION__SUPER,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This adds a property descriptor for the Resolved VI Ref feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addResolvedVIRefPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_VConfiguration_resolvedVIRef_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_VConfiguration_resolvedVIRef_feature", "_UI_VConfiguration_type"),
				 CvlPackage.Literals.VCONFIGURATION__RESOLVED_VI_REF,
				 true,
				 false,
				 true,
				 null,
	...
	/**
	 * This returns VConfiguration.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/VConfiguration"));
	}
	...
	public String getText(Object object) {
		String label = ((VConfiguration)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_VConfiguration_type") :
			getString("_UI_VConfiguration_type") + " " + label;
	}
