...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Pattern Fusion</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.omg.cvl.impl.PatternFusionImpl#getBindingClassifier <em>Binding Classifier</em>}</li>
 *   <li>{@link org.omg.cvl.impl.PatternFusionImpl#isMulti <em>Multi</em>}</li>
 *   <li>{@link org.omg.cvl.impl.PatternFusionImpl#getSubstitutes <em>Substitutes</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PatternFusionImpl extends ChoiceVariationPointImpl implements PatternFusion {
	/**
	...
	protected EClass eStaticClass() {
		return CvlPackage.Literals.PATTERN_FUSION;
	}
		...
		if (bindingClassifier != null && bindingClassifier.eIsProxy()) {
			...
			if (bindingClassifier != oldBindingClassifier) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CvlPackage.PATTERN_FUSION__BINDING_CLASSIFIER, oldBindingClassifier, bindingClassifier));
			}
		}
	...
	public void setBindingClassifier(VClassifier newBindingClassifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CvlPackage.PATTERN_FUSION__BINDING_CLASSIFIER, oldBindingClassifier, bindingClassifier));
	}
	...
	public void setMulti(boolean newMulti) {
		...
		multi = newMulti;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CvlPackage.PATTERN_FUSION__MULTI, oldMulti, multi));
	}
	...
	public EList<ObjectSubstitution> getSubstitutes() {
		if (substitutes == null) {
			substitutes = new EObjectResolvingEList<ObjectSubstitution>(ObjectSubstitution.class, this, CvlPackage.PATTERN_FUSION__SUBSTITUTES);
		}
		return substitutes;
	}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == RepeatableVariationPoint.class) {
			switch (derivedFeatureID) {
				case CvlPackage.PATTERN_FUSION__BINDING_CLASSIFIER: return CvlPackage.REPEATABLE_VARIATION_POINT__BINDING_CLASSIFIER;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == RepeatableVariationPoint.class) {
			switch (baseFeatureID) {
				case CvlPackage.REPEATABLE_VARIATION_POINT__BINDING_CLASSIFIER: return CvlPackage.PATTERN_FUSION__BINDING_CLASSIFIER;
				default: return -1;
			}
		}
