 ...
 * </p>
 * <ul>
 *   <li>{@link org.omg.cvl.impl.ParametricLinkAssignmentImpl#getLinkEndIdentifier <em>Link End Identifier</em>}</li>
 *   <li>{@link org.omg.cvl.impl.ParametricLinkAssignmentImpl#getLink <em>Link</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ParametricLinkAssignmentImpl extends ParametricVariationPointImpl implements ParametricLinkAssignment {
	...
	protected EClass eStaticClass() {
		return CvlPackage.Literals.PARAMETRIC_LINK_ASSIGNMENT;
	}
	...
	public void setLinkEndIdentifier(String newLinkEndIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CvlPackage.PARAMETRIC_LINK_ASSIGNMENT__LINK_END_IDENTIFIER, oldLinkEndIdentifier, linkEndIdentifier));
	}
	...
	public NotificationChain basicSetLink(LinkHandle newLink, NotificationChain msgs) {
		...
		link = newLink;
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CvlPackage.PARAMETRIC_LINK_ASSIGNMENT__LINK, oldLink, newLink);
	...
	public void setLink(LinkHandle newLink) {
		if (newLink != link) {
			...
			if (link != null)
				msgs = ((InternalEObject)link).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CvlPackage.PARAMETRIC_LINK_ASSIGNMENT__LINK, null, msgs);
			if (newLink != null)
				msgs = ((InternalEObject)newLink).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CvlPackage.PARAMETRIC_LINK_ASSIGNMENT__LINK, null, msgs);
			msgs = basicSetLink(newLink, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CvlPackage.PARAMETRIC_LINK_ASSIGNMENT__LINK, newLink, newLink));
	}
