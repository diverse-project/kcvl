...
/**
 * This is the item provider adapter for a {@link org.omg.cvl.IntegerLiteralExp} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IntegerLiteralExpItemProvider extends NumericLiteralExpItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_IntegerLiteralExp_integer_feature", "_UI_IntegerLiteralExp_type"),
				 CvlPackage.Literals.INTEGER_LITERAL_EXP__INTEGER,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_IntegerLiteralExp_type") + " " + integerLiteralExp.getInteger();
	}
