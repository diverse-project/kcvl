...
/**
 * This is the item provider adapter for a {@link org.omg.cvl.RepeatableVariationPoint} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class RepeatableVariationPointItemProvider extends VariationPointItemProvider {
	/**
	 ...
	 * @generated
	 */
	public RepeatableVariationPointItemProvider(AdapterFactory adapterFactory) {
	...
	public String getText(Object object) {
		String label = ((RepeatableVariationPoint)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_RepeatableVariationPoint_type") :
			getString("_UI_RepeatableVariationPoint_type") + " " + label;
	}
