...
public class CvlFactoryImpl extends EFactoryImpl implements CvlFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case CvlPackage.FIXED_SLOT_VALUE_ASSIGNMENT: return createFixedSlotValueAssignment();
			case CvlPackage.FIXED_OBJECT_SUBSTITUTION: return createFixedObjectSubstitution();
			case CvlPackage.OBJECT_EXISTENCE: return createObjectExistence();
			case CvlPackage.LINK_ASSIGNMENT: return createLinkAssignment();
			case CvlPackage.LINK_HANDLE: return createLinkHandle();
			case CvlPackage.CONFIGURABLE_UNIT: return createConfigurableUnit();
			case CvlPackage.COMPOSITE_VARIATION_POINT: return createCompositeVariationPoint();
			case CvlPackage.CV_SPEC: return createCVSpec();
			case CvlPackage.VCONFIGURATION: return createVConfiguration();
			case CvlPackage.VSPEC2_VSPEC_MAPPING: return createVSpec2VSpecMapping();
			...
			case CvlPackage.OCL_EXPRESSION: return createOCLExpression();
			case CvlPackage.VSPEC_TO_CONFIG_MAPPING: return createVSpecToConfigMapping();
			case CvlPackage.SLOT_VALUE_EXISTENCE: return createSlotValueExistence();
			case CvlPackage.PARAMETRIC_LINK_ASSIGNMENT: return createParametricLinkAssignment();
			...
			case CvlPackage.OCL_CONSTRAINT: return createOCLConstraint();
	 ...
	 * @generated
	 */
	public FixedSlotValueAssignment createFixedSlotValueAssignment() {
		FixedSlotValueAssignmentImpl fixedSlotValueAssignment = new FixedSlotValueAssignmentImpl();
		return fixedSlotValueAssignment;
	}
	 ...
	 * @generated
	 */
	public FixedObjectSubstitution createFixedObjectSubstitution() {
		FixedObjectSubstitutionImpl fixedObjectSubstitution = new FixedObjectSubstitutionImpl();
		return fixedObjectSubstitution;
	}
	 ...
	 * @generated
	 */
	public LinkAssignment createLinkAssignment() {
		LinkAssignmentImpl linkAssignment = new LinkAssignmentImpl();
	 ...
	 * @generated
	 */
	public CompositeVariationPoint createCompositeVariationPoint() {
		CompositeVariationPointImpl compositeVariationPoint = new CompositeVariationPointImpl();
		return compositeVariationPoint;
	}
	 ...
	 * @generated
	 */
	public VSpec2VSpecMapping createVSpec2VSpecMapping() {
		VSpec2VSpecMappingImpl vSpec2VSpecMapping = new VSpec2VSpecMappingImpl();
		return vSpec2VSpecMapping;
	}
	 ...
	 * @generated
	 */
	public VSpecToConfigMapping createVSpecToConfigMapping() {
		VSpecToConfigMappingImpl vSpecToConfigMapping = new VSpecToConfigMappingImpl();
		return vSpecToConfigMapping;
	}
	 ...
	 * @generated
	 */
	public ParametricLinkAssignment createParametricLinkAssignment() {
		ParametricLinkAssignmentImpl parametricLinkAssignment = new ParametricLinkAssignmentImpl();
		return parametricLinkAssignment;
	}
	 ...
	 * @generated
	 */
	public PatternIntegration createPatternIntegration() {
		PatternIntegrationImpl patternIntegration = new PatternIntegrationImpl();
		return patternIntegration;
	}
	 ...
	 * @generated
	 */
	public PatternFusion createPatternFusion() {
		PatternFusionImpl patternFusion = new PatternFusionImpl();
