 ...
 * <ul>
 *   <li>{@link org.omg.CVLMetamodelMaster.cvl.impl.ParametricSlotAssignmetImpl#getSlotIdentifier <em>Slot Identifier</em>}</li>
 *   <li>{@link org.omg.CVLMetamodelMaster.cvl.impl.ParametricSlotAssignmetImpl#getSlotOwner <em>Slot Owner</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ParametricSlotAssignmetImpl extends ParametricVariationPointImpl implements ParametricSlotAssignmet {
	...
	protected EClass eStaticClass() {
		return CvlPackage.Literals.PARAMETRIC_SLOT_ASSIGNMET;
	}
	...
	public void setSlotIdentifier(String newSlotIdentifier) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CvlPackage.PARAMETRIC_SLOT_ASSIGNMET__SLOT_IDENTIFIER, oldSlotIdentifier, slotIdentifier));
	}
	...
	public NotificationChain basicSetSlotOwner(ObjectHandle newSlotOwner, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, CvlPackage.PARAMETRIC_SLOT_ASSIGNMET__SLOT_OWNER, oldSlotOwner, newSlotOwner);
	...
	public void setSlotOwner(ObjectHandle newSlotOwner) {
		if (newSlotOwner != slotOwner) {
			...
			if (slotOwner != null)
				msgs = ((InternalEObject)slotOwner).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - CvlPackage.PARAMETRIC_SLOT_ASSIGNMET__SLOT_OWNER, null, msgs);
			if (newSlotOwner != null)
				msgs = ((InternalEObject)newSlotOwner).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - CvlPackage.PARAMETRIC_SLOT_ASSIGNMET__SLOT_OWNER, null, msgs);
			msgs = basicSetSlotOwner(newSlotOwner, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CvlPackage.PARAMETRIC_SLOT_ASSIGNMET__SLOT_OWNER, newSlotOwner, newSlotOwner));
	}
