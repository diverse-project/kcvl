 ...
 * <ul>
 *   <li>{@link org.omg.CVLMetamodelMaster.cvl.impl.PrimitiveValueSpecificationImpl#getExpression <em>Expression</em>}</li>
 *   <li>{@link org.omg.CVLMetamodelMaster.cvl.impl.PrimitiveValueSpecificationImpl#getValue <em>Value</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PrimitiveValueSpecificationImpl extends ValueSpecificationImpl implements PrimitiveValueSpecification {
	...
	public void setValue(String newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CvlPackage.PRIMITIVE_VALUE_SPECIFICATION__VALUE, oldValue, value));
	}
